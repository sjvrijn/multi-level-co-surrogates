...
for k in kernels:
    ...
    for scale in scaling_options:
        ...
        mse_tracking, r2_tracking, values = create_mse_tracking(inv_OD, low_random_sample, gp_kernel=k,
                                                                ...
                                                                scaling=scale)
        np.save(f'{file_dir}{k}1d_mse_tracking.npy', mse_tracking)
        np.save(f'{file_dir}{k}1d_r2_tracking.npy', r2_tracking)
        np.save(f'{file_dir}{k}1d_value_tracking.npy', values)
...
for k in kernels:
    ...
    for scale in scaling_options:
        ...
        np.save(f'{file_dir}{k}2d_mse_tracking.npy', mse_tracking)
        np.save(f'{file_dir}{k}2d_r2_tracking.npy', r2_tracking)
        np.save(f'{file_dir}{k}2d_value_tracking.npy', values)
